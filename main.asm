...
MAIN:
     ...
     SBI  DDRD, 7                  ; set PD7 to output (TL2: red LED)
     SBI  DDRD, 6                  ; set PD6 to output (TL2: yellow LED)
     SBI  DDRD, 5                  ; set PD5 to output (TL2: green LED)
     SBI  DDRD, 4                  ; set PD4 to output (TL2 crosswalk: white)
